...
public class ChessMatch {
	...
	public ChessMatch() {
		board = new Board(8, 8); //ChessMatch is the class which must "know" the size of the chess board.
		turn = 1;
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		if (capturedPiece != null) {
			...
			capturedPieces.remove(capturedPiece);piecesOnTheBoard.add(capturedPiece);
		}
	}
